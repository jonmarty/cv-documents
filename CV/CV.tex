...
\cvitem{Summer 2022}{\textbf{Research Assistant, Center for Computational Mathematics, Flatiron Institute:} Working with a team of researchers on a project attempting to analyze/challenge the validity of recently proposed Interpretability methods to understand the inner workings of artificial neural networks. Involves training non-standard neural network architectures using PyTorch and determining optimization schemes.}
...
\cvitem{2022}{\textit{O.T. Schafer, G.J. Gutierrez, K. Li, A. Mildenhall, D. Spira, J. Marty, A.A. Lazar, M.P. Fernandez, \enquote{Connectomic Analysis of the Drosophila Lateral Neuron Clock Cells Reveals the Synaptic Basis of Functional Pacemaker Classes}, eLife 11:e79139}}
\cvlistitem{\href{https://elifesciences.org/articles/79139}{https://elifesciences.org/articles/79139}}
